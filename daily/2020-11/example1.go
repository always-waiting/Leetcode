...
func (this *ListNode) Line() []int {
	if this == nil {
		return nil
	}
	ret := []int{this.Val}
	if this.Next != nil {
		ret = append(ret, this.Next.Line()...)
	}
	return ret
}
...
func oddEvenList(head *ListNode) *ListNode {
	...
	var evenNodeHead, loopEven *ListNode
	loop := head
	for loop.Next != nil {
		if evenNodeHead == nil {
			evenNodeHead = loop.Next
			loopEven = evenNodeHead
		} else {
			loopEven.Next = loop.Next
